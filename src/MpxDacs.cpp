...
void MpxFsrDef::initDUMMY() {
	...
	v1[0] = std::make_pair<int, int>(3,4);
	m_fsrKeys["testa"] = v1;
	std::vector<std::pair<int, int> > v2;
	v2[0] = std::make_pair<int, int>(8,15);
	m_fsrKeys["testb"] = v2;
	std::vector<std::pair<int, int> > v3;
	v3[0] = std::make_pair<int, int>(32,35);
	v3[1] = std::make_pair<int, int>(44,47);
	m_fsrKeys["testc"] = v3;
}
...
void MpxFsrDef::initTPX1() {
	DEB_MEMBER_FUNCT();
	std::vector<std::pair<int, int> > v1;
	v1[0] = std::make_pair<int, int>(4,11);
	m_fsrKeys["ikrum"] = v1;
	std::vector<std::pair<int, int> > v2;
	v2[0] = std::make_pair<int, int>(12,19);
	m_fsrKeys["disc"] = v2;
	std::vector<std::pair<int, int> > v3;
	v3[0] = std::make_pair<int, int>(20,27);
	m_fsrKeys["preamp"] = v3;
	std::vector<std::pair<int, int> > v4;
	v4[0] = std::make_pair<int, int>(38,39);
	v4[1] = std::make_pair<int, int>(41,42);
	m_fsrKeys["daccode"] = v4;
	std::vector<std::pair<int, int> > v5;
	v5[0] = std::make_pair<int, int>(43,43);
	m_fsrKeys["sensedac"] = v5;
	std::vector<std::pair<int, int> > v6;
	v6[0] = std::make_pair<int, int>(44,44);
	m_fsrKeys["dacsel"] = v6;
	std::vector<std::pair<int, int> > v7;
	v7[0] = std::make_pair<int, int>(46,49);
	v7[1] = std::make_pair<int, int>(56,59);
	m_fsrKeys["buffanaloga"] = v7;
	std::vector<std::pair<int, int> > v8;
	v8[0] = std::make_pair<int, int>(60,67);
	m_fsrKeys["buffanalogb"] = v8;
	std::vector<std::pair<int, int> > v9;
	v9[0] = std::make_pair<int, int>(86,93);
	m_fsrKeys["hist"] = v9;
	std::vector<std::pair<int, int> > v10;
	v10[0] = std::make_pair<int, int>(100,113);
	m_fsrKeys["thl"] = v10;
	std::vector<std::pair<int, int> > v11;
	v11[0] = std::make_pair<int, int>(120,127);
	m_fsrKeys["vcas"] = v11;
	std::vector<std::pair<int, int> > v12;
	v12[0] = std::make_pair<int, int>(128,135);
	m_fsrKeys["fbk"] = v12;
	std::vector<std::pair<int, int> > v13;
	v13[0] = std::make_pair<int, int>(136,143);
	m_fsrKeys["gnd"] = v13;
	std::vector<std::pair<int, int> > v14;
	v14[0] = std::make_pair<int, int>(144,175);
	m_fsrKeys["ctpr"] = v14;
	std::vector<std::pair<int, int> > v15;
	v15[0] = std::make_pair<int, int>(181,188);
	m_fsrKeys["ths"] = v15;
	std::vector<std::pair<int, int> > v16;
	v16[0] = std::make_pair<int, int>(227,234);
	m_fsrKeys["biaslvds"] = v16;
	std::vector<std::pair<int, int> > v17;
	v17[0] = std::make_pair<int, int>(235,242);
...
void MpxFsrDef::initMPX2() {
	DEB_MEMBER_FUNCT();
	std::vector<std::pair<int, int> > v1;
	v1[0] = std::make_pair<int, int>(3,10);
	m_fsrKeys["biasdelayn"] = v1;
	std::vector<std::pair<int, int> > v2;
	v2[0] = std::make_pair<int, int>(11,18);
	m_fsrKeys["biasdisc"] = v2;
	std::vector<std::pair<int, int> > v3;
	v3[0] = std::make_pair<int, int>(19,26);
	m_fsrKeys["biaspreamp"] = v3;
	std::vector<std::pair<int, int> > v4;
	v4[0] = std::make_pair<int, int>(45,48);
	v4[1] = std::make_pair<int, int>(55,58);
	m_fsrKeys["biassetdisc"] = v4;
	std::vector<std::pair<int, int> > v5;
	v5[0] = std::make_pair<int, int>(59,66);
	m_fsrKeys["biasths"] = v5;
	std::vector<std::pair<int, int> > v6;
	v6[0] = std::make_pair<int, int>(99,106);
	m_fsrKeys["biasikrum"] = v6;
	std::vector<std::pair<int, int> > v7;
	v7[0] = std::make_pair<int, int>(107,114);
	m_fsrKeys["biasabuffer"] = v7;
	std::vector<std::pair<int, int> > v8;
	v8[0] = std::make_pair<int, int>(115,122);
	m_fsrKeys["thh"] = v8;
	std::vector<std::pair<int, int> > v9;
	v9[0] = std::make_pair<int, int>(123,130);
	m_fsrKeys["thl"] = v9;
	std::vector<std::pair<int, int> > v10;
	v10[0] = std::make_pair<int, int>(131,138);
	m_fsrKeys["fbk"] = v10;
	std::vector<std::pair<int, int> > v11;
	v11[0] = std::make_pair<int, int>(180,187);
	m_fsrKeys["gnd"] = v11;
	std::vector<std::pair<int, int> > v12;
	v12[0] = std::make_pair<int, int>(226,233);
	m_fsrKeys["biaslvdstx"] = v12;
	std::vector<std::pair<int, int> > v13;
	v13[0] = std::make_pair<int, int>(234,241);
	m_fsrKeys["reflvdstx"] = v13;
	std::vector<std::pair<int, int> > v14;
	v14[0] = std::make_pair<int, int>(37,38);
	v14[1] = std::make_pair<int, int>(40,40);
	v14[2] = std::make_pair<int, int>(41,41);
	m_fsrKeys["daccode"] = v14;
	std::vector<std::pair<int, int> > v15;
	v15[0] = std::make_pair<int, int>(42,42);
	m_fsrKeys["sensedac"] = v15;
	std::vector<std::pair<int, int> > v16;
	v16[0] = std::make_pair<int, int>(43,43);
...
void MpxFsrDef::initMXR2() {
	...
	m_fsrKeys["preamp"] = v3;
	std::vector<std::pair<int, int> > v4;
	v4[0] = std::make_pair<int, int>(37,38);
	v4[1] = std::make_pair<int, int>(40,41);
	m_fsrKeys["daccode"] = v4;
	std::vector<std::pair<int, int> > v5;
	v5[0] = std::make_pair<int, int>(42,42);
	m_fsrKeys["sensedac"] = v5;
	std::vector<std::pair<int, int> > v6;
	v6[0] = std::make_pair<int, int>(43,43);
	m_fsrKeys["dacsel"] = v6;
	std::vector<std::pair<int, int> > v7;
	v7[0] = std::make_pair<int, int>(45,48);
	v7[1] = std::make_pair<int, int>(55,58);
	m_fsrKeys["buffanaloga"] = v7;
	std::vector<std::pair<int, int> > v8;
	v8[0] = std::make_pair<int, int>(59,66);
	m_fsrKeys["buffanalogb"] = v8;
	std::vector<std::pair<int, int> > v9;
	v9[0] = std::make_pair<int, int>(85,92);
	m_fsrKeys["delayn"] = v9;
	std::vector<std::pair<int, int> > v10;
	v10[0] = std::make_pair<int, int>(99,112);
	m_fsrKeys["thl"] = v10;
	std::vector<std::pair<int, int> > v11;
	v11[0] = std::make_pair<int, int>(113,126);
	m_fsrKeys["thh"] = v11;
	std::vector<std::pair<int, int> > v12;
	v12[0] = std::make_pair<int, int>(127,134);
	m_fsrKeys["fbk"] = v12;
	std::vector<std::pair<int, int> > v13;
	v13[0] = std::make_pair<int, int>(135,142);
	m_fsrKeys["gnd"] = v13;
	std::vector<std::pair<int, int> > v14;
	v14[0] = std::make_pair<int, int>(143,174);
	m_fsrKeys["ctpr"] = v14;
	std::vector<std::pair<int, int> > v15;
	v15[0] = std::make_pair<int, int>(180,187);
	m_fsrKeys["ths"] = v15;
	std::vector<std::pair<int, int> > v16;
	v16[0] = std::make_pair<int, int>(226,233);
	m_fsrKeys["biaslvds"] = v16;
	std::vector<std::pair<int, int> > v17;
	v17[0] = std::make_pair<int, int>(234,241);
	m_fsrKeys["reflvds"] = v17;
